    ...
    Starfield.prototype = {
      ...
      init: function() {
        ...
        var canvasInit = function() {
          ...
          that.starfield = $('canvas', that.el);

          if (that.starfield[0].getContext) {
            that.context = that.starfield[0].getContext('2d');
            canCanvas = true;
          }
      ...
      anim: function() {
        this.mouse_x = (this.cursor_x - this.x) * 1;
        this.mouse_y = (this.cursor_y - this.y) * 1;
      ...
      move: function() {
        ...
        function handleOrientation(event) {
          if (event.beta !== null && event.gamma !== null) {
            ...
            that.cursor_x = (that.w / 7) + (x * 5);
            that.cursor_y = (that.h / 7) + (y * 5);
